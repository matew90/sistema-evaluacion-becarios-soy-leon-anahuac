...
class SemanalController extends Controller
{
	...
	public function show(Request $request)
    {
     ...
     return view('ReservaEspacios.week')->with('spaces',$getSpaces)->with('users' , $getUsers)->with('areas' , $getAreas);

    // } catch (\Exception $e) {
      Log::error('Get Spaces and Reservation "Line: 30. ReservaController."');
     return view('ReservaEspacios.week',compact('getSpaces'),compact('getInventories'));
