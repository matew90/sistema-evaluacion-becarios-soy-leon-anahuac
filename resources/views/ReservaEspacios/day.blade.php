  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    <div class="modal-content">
      <div class="modal-header" style="display: block;">
		  <div class="modal-title" style="float: right;"></div>
		  <span></span>
...
<script>
  ...
  $(document).ready(function() {
        ...
        $('#view_reserva2').modal({backdrop: 'static', keyboard: false});
   ...
   $('#calendar').fullCalendar('rerenderEvents');
	  ...
	  /////////////JS CALENDAR//////////////////
	   var calendar =  $('#calendar').fullCalendar({
        ...
        editable:true,
        events:SITEURL+'/reserva-espacios/dia',
       ...
       eventClick:function(event)
        {
			var res_uID = event.res_uID;
			 $.ajax({
       url:SITEURL+'/reserva-espacios/dia/dia/'+ res_uID,
                    type:"GET",
                    data:{
                        res_uID:res_uID
                    },
	...
	var today= year+ "-" + month + "-" + day;
				if(today<start){
				  $.post(SITEURL+"/reserva-espacios/dia/eliminar/" + res_uID)
					.done(function(data) {
                    $("#waiting").hide();
                    ...
                    Swal.fire({
						...
						window.location.replace(SITEURL+"/reserva-espacios/dia");
						})
                });
				   }else{
				   Swal.fire({
