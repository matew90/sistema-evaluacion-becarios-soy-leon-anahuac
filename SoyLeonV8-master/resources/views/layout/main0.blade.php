                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <div class="">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Reserva de espacios</a></li>
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Mes</a></li>
                            ...
                            <ul class="navigation-menu list-unstyled">
                                ...
                                <li class="has-submenu">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="app-contact-list.html">Registro de eventos</a></li>
                                        <li class="has-submenu">
                                            <a href="#">Email</a>
                                            <ul class="submenu">
                                ...
                                <li class="has-submenu">
                                    <a href="#"><i class="mdi mdi-buffer"></i>Registro COVID</a>
                                    <ul class="submenu">
                                ...
                                <div class="card-body dash-info-carousel">
                                    <div id="carousel_best_saler" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <div class="text-center">
                                                    <img src="./public/img/user/user.png" alt="user" class="rounded-circle thumb-xl img-thumbnail mb-1">
                                                    <h5>Matt Rosales</h5>
